    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-compact nav-child-indent nav-collapse-hide-child nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.add_product')}}" class="nav-link {{ (request()->is('admin/add_product*')) ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.all_product')}}" class="nav-link {{ (request()->is('admin/all_product*')) ? 'active' : '' }}">
